        ...
        adminAPI.getStatistics((res) => {
            ...
            if (res.message === 'SUCCESS') {
              ...
              if (this.dataMode === '积分奖励') {
                ...
                this.pointData = [
                  [8, 9.4], [6, 10.7], [5, 6.0], [7, 12.0], [10, 10.3],
                  [12, 19.4], [16, 17.7], [15, 26.0], [20, 32.0], [10, 10.3],
                  [5, 4.4], [6, 5.7], [10, 10.0], [7, 12.0], [10, 10.3],
                  [15, 19.4], [6, 8.7], [5, 6.0], [7, 12.0], [10, 10.3],
                  [18, 29.4], [6, 10.7], [11, 16.0], [7, 12.0], [10, 10.3],
